...
contract SolnSquareVerifier is ERC721Mintable {
    ...
    public ERC721Mintable(name, symbol, baseTokenURI) {
    ...
    function addSolution(uint[2] memory a, uint[2][2] memory b, uint[2] memory c, uint[2] memory input, address to)
    public returns (bool) {
    ...
    function mintNewToken(uint[2] memory a, uint[2][2] memory b, uint[2] memory c, uint[2] memory input, address to, uint256 tokenId)
    public returns (bool) {
